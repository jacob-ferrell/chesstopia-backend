...
public class BishopTest {
  /*   @Test
    public void testEnemiesForWhite() {
        ...
        board.clearBoard();
        board.setPieceAtPosition(new Position(3, 3), bishop);
        board.setPieceAtPosition(new Position(1, 1), new Pawn(PieceColor.BLACK, new Position(1, 1), board));
        board.setPieceAtPosition(new Position(1, 5), new Pawn(PieceColor.BLACK, new Position(5, 1), board));
        board.setPieceAtPosition(new Position(5, 1), new Pawn(PieceColor.BLACK, new Position(1, 5), board));
        board.setPieceAtPosition(new Position(5, 5), new Pawn(PieceColor.BLACK, new Position(5, 5), board));
        Set<Move> possibleMoves = bishop.generatePossibleMoves();
